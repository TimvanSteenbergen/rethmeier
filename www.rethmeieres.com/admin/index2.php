...
$dbcnx = mysqli_connect($server, $username, $password, $database); 
// mysqli_select_db($database, $dbcnx); 
...
if ($_GET['logout']==1){
	...
	if (mysqli_num_rows($exec) == 0){
		...
		while ($row = mysqli_fetch_array($exec)){
			...
			$pageExec = mysqli_query($dbcnx, $pageQuery);
			$to = "index.php";
			while ($pageRow = mysqli_fetch_array($pageExec)){
				$to = $pageRow['ITEM_URL'];
			}
		}
	}
...
<html>
<head>
	<title><?php echo DB_PORTAL?> - Backoffice</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	<tr>
		<td align="center" valign="middle" width="100%">
			<form method="post" action="<?php echo $_PHP_SELF;?>" name="frmLoginAdmin">
							...
							<TD colspan="2"><table width="100%" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td height="248" width="358"  background="images/login.png" valign="bottom" align="center"><table cellspacing="0" cellpadding="0">
										...
										<tr>
											<td width=18>&nbsp;</td>
											<td width=282><input class="fields" type="Text" name="user" size="44" value="<?php echo $_COOKIE['adminuser']; ?>"></td>
                                            <td width=18>&nbsp;</td>
										</tr>
										<tr>
											<td width=18>&nbsp;</td>
										...
										<tr>
											<td width=18>&nbsp;</td>
											<td width=282><input class="fields" type="Password" name="pass" size="44" value="<?php echo $_COOKIE['adminpass']; ?>"></td>
                                            <td width=18>&nbsp;</td>
										</tr>
										<tr>
                                            <td width=18>&nbsp;</td>
